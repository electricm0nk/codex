...
BUCKET_DEFINITIONS = {
    "DONE": {
        ...
        # site.
        "citation": {"file": _ENGINE_SRC, "line": 10631, "must_contain": "grounded"},
    },
    "A": {
        ...
        # real construction site.
        "citation": {"file": _ENGINE_SRC, "line": 13284, "must_contain": "has_no_engine_table"},
    },
    "B": {
        ...
        # content read back and confirmed still the real construction site.
        "citation": {"file": _ENGINE_SRC, "line": 12944, "must_contain": "not_held_by_engine"},
    },
    "C": {
        ...
        # construction site, not a test assertion.
        "citation": {"file": _ENGINE_SRC, "line": 13189, "must_contain": "explanation_id"},
    },
    "D": {
        ...
        # confirmed.
        "citation": {"file": _ENGINE_SRC, "line": 10805, "must_contain": "engine-does-not-hold"},
    },
    "M": {
        ...
        # content read back and confirmed.
        "citation": {"file": _ENGINE_SRC, "line": 10640, "must_contain": "ingested-magnitude"},
    },
    "V": {
        ...
        # not a test assertion.
        "citation": {"file": _ENGINE_SRC, "line": 14066, "must_contain": "literal-verified"},
    },
    "U": {
        ...
        # confirmed.
        "citation": {"file": _ENGINE_SRC, "line": 10892, "must_contain": "unmeasurable"},
    },
    "X": {
        ...
        # confirmed.
        "citation": {"file": _ENGINE_SRC, "line": 10852, "must_contain": "deferred-with-reason"},
    },
    "Z": {
        "meaning": "not started",
        ...
        # and confirmed.
        "citation": {"file": _ENGINE_SRC, "line": 10713, "must_contain": "not-started"},
    },
}
