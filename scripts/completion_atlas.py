...
BUCKET_DEFINITIONS = {
    "DONE": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 9067, "must_contain": "grounded"},
    },
    "A": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 10798, "must_contain": "has_no_engine_table"},
    },
    "B": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 10478, "must_contain": "not_held_by_engine"},
    },
    "C": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 10703, "must_contain": "explanation_id"},
    },
    "D": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 9039, "must_contain": "engine-does-not-hold"},
    },
    "M": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 8874, "must_contain": "ingested-magnitude"},
    },
    "V": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 11449, "must_contain": "literal-verified"},
    },
    "U": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 9126, "must_contain": "unmeasurable"},
    },
    "X": {
        ...
        "citation": {"file": _ENGINE_SRC, "line": 9086, "must_contain": "deferred-with-reason"},
    },
    "Z": {
        "meaning": "not started",
        "clears": "ordinary work",
        "evidence_source": "src/bin/v06_work_inventory.rs (status == not-started)",
        "citation": {"file": _ENGINE_SRC, "line": 8947, "must_contain": "not-started"},
    },
}
