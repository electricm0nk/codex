...
export interface AssembleFeedbackEvidenceInput {
  ...
  surface: TesterWorkbenchSurface;
...
export function captureAutoEvidence(surface: TesterWorkbenchSurface): AutoCapturedEvidence {
...
function sanitizeReference(reference: WorkbenchReference): WorkbenchReference {
  return {
    ...reference,
