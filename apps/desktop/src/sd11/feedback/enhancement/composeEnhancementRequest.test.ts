...
function completeEnhancementPayload(surface: Sd11TesterWorkbenchSurface) {
...
function bodyHasSevenSectionsInContractOrder() {
  ...
  assert(composed.draft.markdownBody.includes('Codex 0.5.97-test'), 'build label present in body');
