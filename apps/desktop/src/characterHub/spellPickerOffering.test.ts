...
const CATALOG: SpellCatalogEntryDto[] = [
  ...
  { key: 'Magic Missile', book: 'CRB', school: 'Evocation', level: 1, description: '1d4+1 force damage.', duration: null },
  // On the wizard list, far above a Wizard 1's castable level. Legal to
  // scribe, so it must survive the filter.
  { key: 'Tsunami', book: 'APG', school: 'Conjuration', level: 9, description: 'A wave of water.', duration: null },
  // The minimum-across-classes defect in one row: the record says 1
  // (Bard's level), a Wizard learns it at 2.
  { key: 'Hideous Laughter', book: 'CRB', school: 'Enchantment', level: 1, description: 'Subject loses actions.', duration: null },
  // Cleric/Druid/Bard spell. On no wizard list — must be removed.
  { key: 'Cure Light Wounds', book: 'CRB', school: 'Conjuration', level: 1, description: 'Cures 1d8 damage.', duration: null },
  // Druid-only. Must be removed.
  { key: 'Antilife Shell', book: 'CRB', school: 'Abjuration', level: 6, description: '10-ft. field hedges out living creatures.', duration: null },
  ...
  { key: 'Corpus Gap Spell', book: 'APG', school: null, level: null, description: null, duration: null },
];
