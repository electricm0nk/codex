...
pub struct ClassFeatureRecordTokens {
...
pub fn merge_bonus_var_target_map_never_overwriting(
...
pub fn class_feature_record_tokens_pre_gate_safe()
...
pub fn resolve_pcgen_var_chain(
