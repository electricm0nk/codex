...
pub fn carries_unimplemented_marker(description: &str) -> bool {
...
pub fn carries_class_specific_level_phrase(description: &str, class_name: &str) -> bool {
...
pub fn raw_desc_has_a_bare_percent_reference_no_pipe_tail_can_resolve(raw: &str) -> bool {
    if raw.contains('|') {
...
pub fn is_real_description_value(value: &str) -> bool {
...
pub fn walk_json_files(dir: &Path, out: &mut Vec<PathBuf>) {
