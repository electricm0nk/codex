    ...
    TABLE.get_or_init(|| {
        ...
        ArchetypeSwapEntry {
            ...
            grants: &[
                ...
                ArchetypeGrant { grants_feature_key: "Mutagenic Mauler Brawler ~ Beastmorph", at_level: 4, description: Some("A mutagenic mauler gains additional abilities when using her mutagen. She gains low-light vision and a +%1 enhancement bonus to her base speed."), benefit: None },
