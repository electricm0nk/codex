...
pub const PANACHE_TABLE: &[FeatTableEntry] = &[
    ...
    FeatTableEntry { key: "Extra Panache", category: FeatCategory::Panache, name: "Extra Panache", description: Some("You have more panache than the ordinary swashbuckler."), effect: Some(&[FeatEffectBonus { qualifiers: &["VAR", "PanachePoints", "2"] }, FeatEffectBonus { qualifiers: &["VAR", "Panache_Cap", "2"] }])},
