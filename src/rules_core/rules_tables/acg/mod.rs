...
/// Bloodrager, Brawler, Hunter, Investigator, Shaman, and Skald are the
/// first seven real ACG classes landed; the roster grows as subsequent
/// Epic 4 cycles ingest the remaining 3 real classes (Slayer,
