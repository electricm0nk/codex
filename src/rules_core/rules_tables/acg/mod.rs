...
/// Bloodrager, and Brawler are the first three real ACG classes landed;
/// the roster grows as subsequent Epic 4 cycles ingest the remaining 7
/// real classes (Hunter, Investigator, Shaman, Skald, Slayer,
