    ...
    TABLE.get_or_init(|| {
        ...
        ArchetypeSwapEntry {
            ...
            grants: &[
                ...
                ArchetypeGrant { grants_feature_key: "Armor Master ~ Armored Defense", at_level: 5, description: Some("An armor master gains DR 1/- when wearing light armor, DR 2/- when wearing medium armor, and DR 3/- when wearing heavy armor."), benefit: None },
