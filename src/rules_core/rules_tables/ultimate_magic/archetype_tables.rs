    ...
    TABLE.get_or_init(|| {
        ...
        ArchetypeSwapEntry {
            ...
            grants: &[
                ...
                ArchetypeGrant { grants_feature_key: "Oath against Undeath ~ Ghost Touch Aura", at_level: 3, description: Some("Your armor is treated as if it had the ghost touch armor property. This does not affect the cost or effect of any other abilities of the armor."), benefit: None },
