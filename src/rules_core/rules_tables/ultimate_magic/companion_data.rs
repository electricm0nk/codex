...
pub(super) static COMPANIONS: &[CompanionRecord] = &[
    CompanionRecord {
        ...
        natural_attack_damage_bonuses: &[NaturalAttackDamageBonus { attack: "Tentacles", formula: "-STR", conditions: &[] }],
    ...
    CompanionRecord {
        ...
        natural_attack_damage_bonuses: &[NaturalAttackDamageBonus { attack: "Sting", formula: "max(0,(STR/2))", conditions: &[] }],
        skill_ability_diff_bonuses: &[SkillAbilityDiffBonus { skills: &["Climb", "Swim"], formula: "DEX-STR" }],
...
pub(super) static COMPANION_ABILITIES: &[CompanionAbilityRecord] = &[
    ...
    CompanionAbilityRecord {
        ...
        description_variables: &[],
        description_variants: &[CompanionDescriptionVariant { text: "A giant leech drains blood at the end of each turn it is attached", variables: &[], conditions: &[] }, CompanionDescriptionVariant { text: " inflicting 1 point of Strength damage.", variables: &[], conditions: &[EffectCondition { negated: true, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Leech (Giant))" }], alternatives: &[] }] }, CompanionDescriptionVariant { text: " inflicting 1 point of Strength  and Constitution damage.", variables: &[], conditions: &[EffectCondition { negated: false, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Leech (Giant))" }], alternatives: &[] }] }],
        stat_adjustments: &[],
        source_page: Some("p.36"),
    ...
    CompanionAbilityRecord {
        ...
        description_variables: &[],
        description_variants: &[CompanionDescriptionVariant { text: "Frequency 1 round [6]", variables: &[], conditions: &[] }, CompanionDescriptionVariant { text: " effect 1 Str damage, cure 1 save, DC %1", variables: &["GiantScorpionCompanionPoisonDC"], conditions: &[EffectCondition { negated: true, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Scorpion (Giant))" }], alternatives: &[] }] }, CompanionDescriptionVariant { text: " effect 1d2 Str damage, cure 1 save, DC %1", variables: &["GiantScorpionCompanionPoisonDC"], conditions: &[EffectCondition { negated: false, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Scorpion (Giant))" }], alternatives: &[] }] }],
        stat_adjustments: &[],
        source_page: Some("p.37"),
    ...
    CompanionAbilityRecord {
        ...
        description: None,
        description_variables: &[],
        description_variants: &[CompanionDescriptionVariant { text: "A giant slug tongue attack does an extra 1 point of acid damage.", variables: &[], conditions: &[EffectCondition { negated: true, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Slug (Giant))" }], alternatives: &[] }] }, CompanionDescriptionVariant { text: "A giant slug tongue attack does an extra 1d2 points of acid damage.", variables: &[], conditions: &[EffectCondition { negated: false, family: "ABILITY", items: &[ConditionItem { facet: None, value: "1" }, ConditionItem { facet: Some("CATEGORY"), value: "Special Ability" }, ConditionItem { facet: None, value: "Companion Advancement (Slug (Giant))" }], alternatives: &[] }] }],
        stat_adjustments: &[],
        source_page: Some("p.37"),
