...
pub fn archetype_swap_tables() -> &'static [ArchetypeSwapEntry] {
    ...
    TABLE.get_or_init(|| {
        ...
        ArchetypeSwapEntry {
            ...
            grants: &[
                ArchetypeGrant { grants_feature_key: "Thoughtsinger ~ Collective", at_level: 1, description: Some("Join %1 minds, plus your own, within %2 feet; can manifest some powers through collective."), benefit: None },
