...
const EQUIPMENT_TABLE: &[EquipmentTableEntry] = &[
    ...
    EquipmentTableEntry { key: "Heartstaff", category: EquipmentCategory::MagicItems, name: "The Heartstaff", cost_gp: None, weight_lbs: Some(5.0_f64), description: Some("Can hold psicrystal, 3 setting stones, 10 companion stones; Can hold psicrystal, 5 setting stones, 10 companion stones; psicrystal repairs 1 hp/minute; double personality bonuses [not implemented]") }, // up_equipment.lst:469
...
const EQUIPMODS_TABLE: &[EquipmentTableEntry] = &[
    ...
    EquipmentTableEntry { key: "Special Quality ~ Dancing Robes of Sharatwan / Determination", category: EquipmentCategory::Equipmods, name: "Determination for Dancing Robes of Sharatwan", cost_gp: None, weight_lbs: None, description: Some("1/day automatic breath of life at 0 hp") }, // up_equipmods.lst:140
    ...
    EquipmentTableEntry { key: "Special Quality ~ Severis / Scourgebane", category: EquipmentCategory::Equipmods, name: "Scourgebane for Severis", cost_gp: None, weight_lbs: None, description: Some("extra +2 enhancement, +2d6 damage against phrenic scourge creatures") }, // up_equipmods.lst:146
];
