...
/// recognition: direct computed recognition of seven grounded PF1 Core Rulebook
/// Gnome racial trait dimensions (ability modifiers, size, speed, senses, Keen
/// Senses, Illusion Resistance, Defensive Training) that stays explicitly
/// honest about the remaining unproven Gnome family surface.
const SD18_GNOME_KEEN_SENSES_TEST: &str = "tests/sd13_gnome_race_semantics_recognition.rs + \
    ...
    tests/sd18_gnome_defensive_training.rs";
...
/// Keen Senses, Sure-Footed, Fearless) that stays explicitly honest about the
/// remaining unproven Halfling family surface.
const SD18_HALFLING_FEARLESS_TEST: &str = "tests/sd13_halfling_race_semantics_recognition.rs \
    + tests/sd18_halfling_keen_senses.rs + tests/sd18_halfling_sure_footed.rs \
    + tests/sd18_halfling_fearless.rs";
    ...
    SupportStateMatrix {
        rows: vec![
            ...
            SupportStateRow {
                ...
                dimension: "bounded Dwarf race semantics: seven grounded PF1 Core Rulebook \
                            Dwarf racial trait dimensions (ability modifiers, size, speed, \
                            senses, Stonecunning, Greed, Hardy) recognized on the compute \
                            seam, with the remaining Dwarf family surface still unproven",
                support_state: SupportState::Partial,
                evidence_tier: EvidenceTier::Computed,
                evidence_freshness: EvidenceFreshness::RefreshableFromLiveProof,
                grounding_ref: SD13_DWARF_LEVEL1_TEST,
                blocker_or_lossiness_note: "SD13-E2 plus the SD18 dwarf-stonecunning, \
                    dwarf-greed, and dwarf-hardy cycles leave direct computed evidence that \
                    seven Dwarf race-semantic families are recognized on the compute seam \
                    (ability modifiers: +2 Constitution / -2 Charisma; size: Medium; speed: \
                    20 ft, never reduced by armor or encumbrance; senses: Darkvision 60 ft; \
                    ...
                    precious-metal/gemstone goods; Hardy: flat +2 racial bonus on saving \
                    throws against poison, spells, and spell-like abilities), but the \
                    remaining families stay unproven: Defensive Training, Stability, Hatred, \
                    and weapon familiarity. PF1 core Dwarves gain no racial bonus feat, so \
                    that family is not applicable rather than unproven. No numeric mechanical \
                    contribution beyond the flat Stonecunning/Greed/Hardy bonus magnitudes is \
                    fabricated for any of the seven recognized dimensions.",
                next_required_uplift: "later SD18 slice grounding one or more of the remaining \
                    Dwarf families (Defensive Training, Stability, Hatred, \
            ...
            SupportStateRow {
                ...
                dimension: "bounded Gnome race semantics: seven grounded PF1 Core Rulebook \
                            Gnome racial trait dimensions (ability modifiers, size, speed, \
                            senses, Keen Senses, Illusion Resistance, Defensive Training) \
                            recognized on the compute seam, with the remaining Gnome family \
                ...
                blocker_or_lossiness_note: "SD13-E2 and SD18 leave direct computed evidence \
                    that seven Gnome race-semantic families are recognized on the compute seam \
                    ...
                    Training: flat +4 dodge bonus to AC vs. giants), but the remaining families \
                    stay unproven: Hatred, Gnome Magic, and weapon familiarity. PF1 core Gnomes \
                    ...
                    skill-bonus magnitude, the flat Illusion Resistance save-bonus magnitude, \
                    and the flat Defensive Training dodge-bonus magnitude is fabricated for any \
                    of the seven recognized dimensions.",
                next_required_uplift: "later SD18 slice grounding one or more of the \
                    remaining Gnome families (Hatred, Gnome Magic, weapon familiarity) as a \
            ...
            SupportStateRow {
                ...
                dimension: "bounded Halfling race semantics: seven grounded PF1 Core Rulebook \
                            Halfling racial trait dimensions (ability modifiers, size, speed, \
                            senses, Keen Senses, Sure-Footed, Fearless) recognized on the \
                            compute seam, with the remaining Halfling family surface still \
                            unproven",
                support_state: SupportState::Partial,
                evidence_tier: EvidenceTier::Computed,
                evidence_freshness: EvidenceFreshness::RefreshableFromLiveProof,
                grounding_ref: SD18_HALFLING_FEARLESS_TEST,
                blocker_or_lossiness_note: "SD13-E2/SD18 leaves direct computed evidence that \
                    seven Halfling race-semantic families are recognized on the compute seam \
                    ...
                    saving-throw-vs-fear racial bonus), but the remaining families stay \
                    unproven: Halfling Luck and weapon familiarity. PF1 core Halflings gain no \
                    racial bonus feat, so that family is not applicable rather than unproven. \
                    No numeric mechanical contribution is fabricated for any of the three \
                    non-skill-bonus, non-save-bonus recognized dimensions.",
                next_required_uplift: "later SD13-E2/SD18 slice grounding one or more of the \
                    remaining Halfling families (Halfling Luck, weapon familiarity) as a real \
                    computed contribution",
            },
            // ----- Class rows (12) -----
            SupportStateRow {
            ...
            SupportStateRow {
                ...
                dimension: "bounded spell-bearing class progression: the deterministic Human Cleric \
                            ...
                            level 10, increasing to 6d6 at level 11), the domain choice seam, the flat \
                            ...
                            increasing to 6 at level 11), Touch of Good (Good domain, in full, sacred bonus \
                            ...
                            level 9-10, unchanged at level 11), and Rebuke Death's \
                ...
                blocker_or_lossiness_note: "SD13-E4 leaves direct computed evidence that the \
                    ...
                    * 3 / 4, the same formula shape as Rogue/Monk/Druid) and base save progression \
                    ...
                    Cleric level 12+ is proven. No touch-attack resolution, healing-application \
                ...
                next_required_uplift: "SD13-E5+ Cleric domain power grounding: the Rebuke Death \
                    ...
                    burden, then Cleric level 12+ progression",
            },
            SupportStateRow {
                ...
                blocker_or_lossiness_note: "SD13-E4 leaves direct computed evidence that the \
                    ...
                    11 either — only the existing pillars are widened. The row is Partial, not Supported: the animal companion execution \
                ...
                next_required_uplift: "SD13-E5 Druid animal companion execution slice, the Wild \
                    ...
                    level 12+ progression (out of scope for this slice)",
            },
            SupportStateRow {
            ...
            SupportStateRow {
                ...
                dimension: "bounded hybrid class progression: the deterministic Human \
                            ...
                            level 10 and staying 4/day at level 11 while the damage bonus \
                            keeps rising every level), lay on \
                            hands and divine grace grounded for real at levels 2-11 (correct PF1 \
                            ...
                            both axes again at level 10, and staying numerically unchanged at \
                            level 11), mercy \
                            grounded as a correct PF1 CRB level-gate absence at \
                            levels 1-2 and a granted choice-recognition record at levels 3-11, \
                            channel positive energy grounded as a correct PF1 CRB level-gate \
                            absence at levels 1-3 and a flat die-count magnitude at levels 4-11 \
                            ...
                            at level 10, and genuinely increasing to 6d6 at level 11), the \
                            ...
                            level 10, and a genuine value of 8 at level 11, Aura of Justice \
                            newly grounded at level 11 as a bounded grant-only identity record, \
                ...
                blocker_or_lossiness_note: "SD13-E3/E4/E5 leaves direct computed evidence that the \
                    ...
                    codebase to apply the shared smite to. The row is Partial, not \
                    Supported: the F6 hybrid chassis pair (class-feature and spell) stays \
                    claim-blocking as accepted hybrid truth, no Paladin level 12+ is proven, \
                    Divine Bond stays named-but-unproven, the level-6 and level-9 repeat \
                    mercy selections \
                    stay named-but-unproven, Aura of Justice's own smite-sharing resolution is \
                    not computed, and the partial-caster spell burden itself \
