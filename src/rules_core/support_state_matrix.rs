...
/// Keen Senses, Sure-Footed) that stays explicitly honest about the remaining
/// unproven Halfling family surface.
const SD18_HALFLING_SURE_FOOTED_TEST: &str = "tests/sd13_halfling_race_semantics_recognition.rs \
    ...
    SupportStateMatrix {
        rows: vec![
            ...
            SupportStateRow {
                ...
                dimension: "bounded Halfling race semantics: six grounded PF1 Core Rulebook \
                            Halfling racial trait dimensions (ability modifiers, size, speed, \
                            senses, Keen Senses, Sure-Footed) recognized on the compute seam, \
                            with the remaining Halfling family surface still unproven",
                support_state: SupportState::Partial,
                evidence_tier: EvidenceTier::Computed,
                evidence_freshness: EvidenceFreshness::RefreshableFromLiveProof,
                grounding_ref: SD18_HALFLING_SURE_FOOTED_TEST,
                blocker_or_lossiness_note: "SD13-E2/SD18 leaves direct computed evidence that \
                    six Halfling race-semantic families are recognized on the compute seam \
                    ...
                    Sure-Footed: flat +2 Acrobatics/Climb racial bonus), but the remaining \
                    families stay unproven: Fearless, Halfling Luck, and weapon familiarity. \
                    ...
                    fabricated for any of the four non-skill-bonus recognized dimensions.",
                next_required_uplift: "later SD13-E2/SD18 slice grounding one or more of the \
                    remaining Halfling families (Fearless, Halfling Luck, weapon familiarity) \
