...
// =============================================================================
//
// Slice D relocated the aggregate `ParsedLstRecord` from the LST parser
// surface (where the per-kind parsers live) into this module. The
// umbrella `lst_parser::mod.rs` does not re-export it because the
// canonical home IS this module — every consumer imports
// `codex::pcgen_import::ir_converter::ParsedLstRecord` and dispatches
// on it via `convert_to_ir`.
