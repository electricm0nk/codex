...
//! the live side reads [`crate::rules_core::record_vars::RecordVarPackage::spell_formulas`].
//!
...
use crate::rules_core::derived_evaluator_fixture_check::{
...
mod tests {
    use super::*;
    use crate::rules_core::derived_evaluator_fixture_check::SETTLED_SPELL_KEY_SEPARATOR;
