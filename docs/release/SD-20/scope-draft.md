...
- **Boundary contract artifact.** NEW doc `docs/release/SD-20/boundary-contract.md` (engine-side API surface, three sections: CharacterInput shapes, PilotReceipt fields, printed-sheet cell map).
