...
| 16 | `reverify-fixture-verified` | 5 | AT-33-E5-001 | in-progress | `artifacts/epic-5-reverification/AT-33-E5-001_cycle_receipt.md` (1,128 of 1,741 examined — 279 agree/103 disagree/746 unverifiable; remaining 613 named: 598 no-casting-ability-mapping + 15 class_feature). Remediation-wave-2 sibling lane `equipment-remainder`: `artifacts/epic-5-reverification/AT-33-E5-remainder-equipment_cycle_receipt.md` (494-unit equipment slice of the 1,390 remainder; 103 examined — 65 agree/1 disagree/37 unverifiable; 391 named-unexamined). Remediation-wave-2 sibling lane `spell-remainder`: `artifacts/epic-5-reverification/AT-33-E5-remainder-spell_cycle_receipt.md` (815-unit spell slice of the 1,390 remainder — 598 fixture-verified + 217 literal-verified; 100 examined via live oracle — 55 agree/0 disagree/45 unverifiable; 715 unexamined, each with a real per-unit structural reason). |
| 17 | `reverify-literal-verified` | 5 | AT-33-E5-002 | complete | `artifacts/epic-5-reverification/AT-33-E5-002_cycle_receipt.md` (5,812 of 6,589 dispositioned: 41 agree, 5,771 unverifiable-with-reason; 777 remain unexamined, named per-shape). Remediation-wave-2 sibling lane `equipment-remainder`: `artifacts/epic-5-reverification/AT-33-E5-remainder-equipment_cycle_receipt.md` (same 494-unit slice, see row 16). Remediation-wave-2 sibling lane `spell-remainder`: `artifacts/epic-5-reverification/AT-33-E5-remainder-spell_cycle_receipt.md` (same 815-unit slice, see row 16). |
