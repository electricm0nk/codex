...
- verdict: **FAILED** — search for 'Darkvision' still shows 10 rows — filter did not apply (search click missed the box) or the query is too broad; the record cannot be proven in the screenshot viewport
- family: `race_trait` · record: `Darkvision`
- expected on screen: `Duergar`
- agent: `sd31-w5-integrate` · date: 2026-08-16T07:25:01Z
- HEAD: `248315c63`
