...
- verdict: **FAILED** — search for 'Native Outsider' still shows 10 rows — filter did not apply (search click missed the box) or the query is too broad; the record cannot be proven in the screenshot viewport
- family: `race_trait` · record: `Native Outsider`
- expected on screen: `Aasimars are outsiders with the native subtype`
- agent: `sd31-w5-integrate` · date: 2026-08-16T07:24:12Z
- HEAD: `248315c63`
