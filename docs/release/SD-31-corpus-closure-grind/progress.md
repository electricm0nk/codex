...
more carry genuine-but-short (<20-char) quotes. Logged to `OPEN-ISSUES.md` row 8 (`NOTE`) with the
...
out-of-scope defect. `OPEN-ISSUES.md` row 9 (`NOTE`) records the decision and names the exact stage
...
- `docs/release/SD-31-corpus-closure-grind/artifacts/OPEN-ISSUES.md` — rows 3/4/5 moved to Resolved
  (row 5 explicitly as "improved, not fully resolved"); rows 8/9/10 opened.
