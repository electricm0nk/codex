...
**17 units, spanning 6 kinds — 17/17 hand-labelled `ambiguous`, agreeing with the engine.** Read every
...
Logged as `OPEN-ISSUES.md` row 22 (`NOTE`) with the measured blast radius and a concrete ruling
...
Logged `OPEN-ISSUES.md` row 23 (`RULING-NEEDED`) with all four `decisions.md §3` items for the
...
of problem than pattern-matching a finite token grammar, corroborated by 17/17 ground-truth agreement
