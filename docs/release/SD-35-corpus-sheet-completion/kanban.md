...
| 24 | `formula-evaluator-leaves-live` | 6 | AT-35-E6-001 | in-progress | `artifacts/epic-6-pcgen-exit/AT-35-E6-001_cycle3_receipt.md` — cycle 3; residue `253/12354 → 253/12336`, `pre_tokens` `19 → 0` hits (closed); 1 file remains, `class_feature_grant_consumer.rs` (`PcgenFormulaEvaluator` 6, `bonus_stack_reader` 9) |
