...
| 15 | `epic-3-rate-ledger` | 3 | AT-35-E3-004 | complete | `artifacts/epic-3-place-and-surface/AT-35-E3-004_cycle1_receipt.md` — `697b7780ea`; `rate-ledger.json` all 5 Epic 3 cycles, one row each, re-verified against their receipts (0 discrepancies); `builds_recorded` 0/3/3/1/0, `pcgen_live_files` 260 throughout |
