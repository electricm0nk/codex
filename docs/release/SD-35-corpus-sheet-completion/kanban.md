...
| 15 | `epic-3-rate-ledger` | 3 | AT-35-E3-004 | complete | `artifacts/epic-3-place-and-surface/rate-ledger.json` — all 4 Epic 3 cycles, one row each, transcribed from their own receipts |
