...
| 16 | `bucket-m-zero` | 4 | AT-35-E4-001 | complete | `artifacts/epic-4-resolve-and-verify/AT-35-E4-001_cycle1_receipt.md` — `PENDING_SELF_SHA` (cycle start `07e29075b4`); M = 0 and refused non-DONE = 0 carried from `AT-35-E3-002_cycle1_receipt.md` (`26bdfa8d5b`); this cycle closed the third Evidence clause — 24 mapping rows + 1 head alias took `token-coverage.json` `unmapped_token_types` 25 → 0, degraded records 974 → 603, oracle lines 42/41 → 146/145 with 0 new disagreements |
