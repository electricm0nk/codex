...
| 24 | `formula-evaluator-leaves-live` | 6 | AT-35-E6-001 | in-progress | `artifacts/epic-6-pcgen-exit/AT-35-E6-001_cycle1_receipt.md` — `7eaa1e948d`; residue `live_files=260 → 254`, the three identifiers `100/20/20 → 28/13/19` hits, not zero; parity outputs byte-identical before/after; 9 files remain in 4 named families |
