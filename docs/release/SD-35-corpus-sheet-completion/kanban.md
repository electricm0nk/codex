...
| 24 | `formula-evaluator-leaves-live` | 6 | AT-35-E6-001 | in-progress | `artifacts/epic-6-pcgen-exit/AT-35-E6-001_cycle2_receipt.md` — cycle 2; residue `254/12396 → 253/12354`, the three identifiers `28/13/19 → 6/9/19` hits, not zero; parity disagreements identical (0 introduced, 0 fixed); 5 files remain in 2 named families |
