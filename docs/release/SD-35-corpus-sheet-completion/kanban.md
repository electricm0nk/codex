...
| 11 | `first-corpus-wide-conversion` | 3 | AT-35-E2-005 | partial | `artifacts/epic-2-sheet-rule/AT-35-E2-005_cycle3_receipt.md` (cycles 1–2: `…_cycle1_receipt.md`, `…_cycle2_receipt.md`); `artifacts/epic-2-sheet-rule/oracle-parity/sheet-parity.json`; `docs/retro/events/at-35-e2-005.jsonl` — `c0f16fe417` (cycle 3: parity 41/42 agree, 1 disagreement named — Weapon Focus, a holdings gap; 0 closed by the criterion's no-mapping rule; 1,404 remain: 659 refused by token type, 745 non-promotable statuses; §8's >10-type rule: re-scope, not a cycle 4) |
