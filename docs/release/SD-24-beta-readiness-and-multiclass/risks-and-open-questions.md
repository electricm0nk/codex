...
- **APG/ACG-class multiclass.** Per Epic 4's coverage report findings, APG/ACG classes may not be fully wired; SD-24 multiclass is Fighter+Wizard only. APG/ACG multiclass is deferred to SD-25 (default) or operator-pinned later bundle.
