...
| 13 | `epic-9-version` | IN-FLIGHT | Build Version Numbering | first concrete value `0.9.<build>` | `epic-1-identifier` | sd29-e9-version | 2026-08-11T00:00:00Z | SD29-E9-F1-001 |
