...
| 29 (Epic 8 release-closure-checklist) | `docs/release/SD-22/release-closure-checklist.md` (relocated 2026-07-20 from a stray `docs/SD-22/` path) | The four-step closure-process checklist |
