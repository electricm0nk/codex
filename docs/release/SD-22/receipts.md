...
- cycle_id: 2026-07-20T08:20:01Z
  ...
  branch_tip_after: 7052125
  merge_receipt_sha: 7052125e8d5441f50861c63db2f73eeeddf7d7c8
  ...
  rule_set_used: Bestiary1
  kanban_card: "t_445067dd (codex-tranche-5, status=done)"
  progress_file_updated: "yes"
...
- cycle_id: 2026-07-20T09:21:36Z
  ...
  branch_tip_before: 6c679fe (an unrelated merge, 8b74928, landed on tranche/5 mid-cycle from a disjoint file set -- apps/desktop/src/campaign + settings; fast-forward-pulled before this cycle's own commit, no conflict)
  branch_tip_after: 09bfe2e
  merge_receipt_sha: 09bfe2e4101906bd6534f954b96890d611010541
  ...
  rule_set_used: Bestiary1
  kanban_card: "t_0a667602 (codex-tranche-5, status=done)"
  progress_file_updated: "yes"
...
- cycle_id: 2026-07-20T09:50:25Z
  epic: 5
  criterion: beastiary1_subset_08
  criterion_section: "§3.1 Epic 5 — Bestiary 1 content-source ingest (subset 08, eighth monster-block subset, CR 3 continued)"
  row_or_kind: ingest:beastiary1_subset
  evidence_tier_before: complete (criteria 14-17, subset 01 + subset 02 + subset 03 + subset 04 + subset 05 + subset 06 + subset 07)
  evidence_tier_after: complete (criteria 14-17, re-verified against an eighth subset: Doppelganger, Dryad, Ettercap, Gelatinous Cube, Hell Hound -- 41 monsters total, 8 of a default 8-12 subsets)
  branch_tip_before: e0435a6
  branch_tip_after: "(pending; backfilled in next commit per the repo's own backfill convention)"
  merge_receipt_sha: "(pending; backfilled in next commit)"
  cycle_artifact_path: "beastiary1/subset_08_cycle_receipt.md"
  red_phase_evidence: "cargo test --locked --test sd22_beastiary1_subset_08_resolves against the pre-cycle tree failed to compile with error[E0599]: no variant, associated function, or constant named `Doppelganger`/`Dryad`/`Ettercap`/`GelatinousCube`/`HellHound` found for enum `MonsterId` (14 call sites) -- see cycle_artifact_path:Red-phase evidence"
  green_phase_evidence: "wrote src/rules_core/rules_tables/beastiary1/monster_subset_08.rs (Doppelganger/Dryad/Ettercap/Gelatinous Cube/Hell Hound chassis, transcribed from b1_races.lst:127,141,175,189,230) and wired it into beastiary1/mod.rs (pub mod monster_subset_08, five new MonsterId variants, match arms, key_resolve entries) -- diff is purely additive, no existing lines changed. No parser widening needed. Two shapes exercised, both with precedent from prior subsets: Doppelganger and Hell Hound each carry a RACESUBTYPE: token (Doppelganger single-value Shapechanger; Hell Hound pipe-separated multi-value Evil|Extraplanar|Fire|Lawful, transcribed verbatim, same shape subset 07's Derro proved for single-value), and Ettercap carries two separate NATURALATTACKS: tab fields (Bite 1d6, Claw 1d4) accumulating in row order (same shape subset 05's Sahuagin/Skum and subset 06's Troglodyte already proved). sd22_beastiary1_subset_08_resolves 6/6 passed, full cargo test --locked 0 failed across 428 test-result:ok blocks, clippy clean -- see cycle_artifact_path:Green-phase evidence"
  cargo_test_summary: "sd22_beastiary1_subset_08_resolves: 6/6 passed; full cargo test --locked: 0 failed (428 test-result:ok blocks); cargo clippy --locked --tests -- -D warnings clean"
  clippy_signal: clean
  cycle_timing_seconds: 1900
  self_heals_applied: []
  next_required_uplift: "Bestiary 1 subset 09 (if the operator/orchestrator decides Epic 5 should continue past the default range's floor) -- 10 unused non-parenthetical CR-3 names remain (Lion, Ogre, Pegasus, Rust Monster, Shadow, Unicorn, Violet Fungus, Wasp Swarm, Wight, Yeth Hound), enough for two more full five-monster subsets before CR 4. This cycle's assessment (see subset_08_cycle_receipt.md): Epic 5 has now reached 8 of the default 8-12 subset range's floor and is reasonably closeable here, pending an explicit operator/orchestrator closure call -- not unilaterally closed by this cycle."
  corpus_input_path: "pathfinder/paizo/roleplaying_game/bestiary/b1_races.lst:127,141,175,189,230 (Doppelganger, Dryad, Ettercap, Gelatinous Cube, Hell Hound real CR:3 records; per decisions.md §5)"
  rule_set_used: Bestiary1
  kanban_card: "(pending; minted after commit per Step 10b)"
  progress_file_updated: "yes"
