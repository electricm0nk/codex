...
| 6 | CR 1 + CR 2 (band-exhaustion cleanup — only 2 unused non-parenthetical CR:1 names and only 4 unused non-parenthetical CR:2 names remained, neither enough alone for a five-monster subset) | **Added 2026-07-20:** Squid, Troglodyte (last 2 unused CR-1 names), Vargouille, Wolverine, Worg, Yellow Musk Creeper (last 4 unused CR-2 names) — combined into one six-monster subset so CR 1 and CR 2 are both fully exhausted and subset 07 can start CR 3 cleanly — see `beastiary1/subset_06_cycle_receipt.md` | `src/rules_core/rules_tables/beastiary1/monster_subset_06.rs` | `tests/sd22_beastiary1_subset_06_resolves.rs` | `beastiary1/subset_06_cycle_receipt.md` | `RuleSetId::Bestiary1` |
| 7 | CR 3 (moved from CR 1/CR 2 — both fully exhausted after subset 06; 20 clean non-parenthetical CR-3 names exist in the real corpus) | **Added 2026-07-20:** Ankheg, Assassin Vine, Centaur, Cockatrice, Derro (first five real, non-parenthetical CR-3 monster names alphabetically — see `beastiary1/subset_07_cycle_receipt.md`) | `src/rules_core/rules_tables/beastiary1/monster_subset_07.rs` | `tests/sd22_beastiary1_subset_07_resolves.rs` | `beastiary1/subset_07_cycle_receipt.md` | `RuleSetId::Bestiary1` |
| 8 | CR 3 (continued — 20 clean non-parenthetical CR-3 names exist in the real corpus; subset 07 used the first five) | **Added 2026-07-20:** Doppelganger, Dryad, Ettercap, Gelatinous Cube, Hell Hound (next five real, non-parenthetical CR-3 monster names alphabetically after subset 07's "Derro"; `Hell Hound (Nessian)` is a parenthetical, higher-CR sub-variant, excluded — see `beastiary1/subset_08_cycle_receipt.md`) | `src/rules_core/rules_tables/beastiary1/monster_subset_08.rs` | `tests/sd22_beastiary1_subset_08_resolves.rs` | `beastiary1/subset_08_cycle_receipt.md` | `RuleSetId::Bestiary1` |
| ... | (one per subset; subset 09 continues CR 3 — 10 clean names remain: Lion, Ogre, Pegasus, Rust Monster, Shadow, Unicorn, Violet Fungus, Wasp Swarm, Wight, Yeth Hound) | ... | ... | ... | ... | ... |
