...
|---|---|---|---|
| `apg/` | Advanced Player's Guide | `class_alchemist.lst.md`, `class_cavalier.lst.md`, `class_gunslinger.lst.md`, `class_inquisitor.lst.md`, `class_magus.lst.md`, `class_oracle.lst.md`, `class_summoner.lst.md`, `class_witch.lst.md` (eight APG classes; aligns 1:1 with `corpus-source-inventory.md` §1.1) | stub (representative content; operator replaces at cycle-launch) |
