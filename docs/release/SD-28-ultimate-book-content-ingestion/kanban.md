...
| 14 | `epic-15-unknown-sweep` | IN-FLIGHT | Classification sweep | 3,734-unit `unknown` bucket characterised (not closed): 438 (13%) archetype tier-2 content (via `epic-32`'s 403-record catalog), 2,989 (87%) class-native option-pool content; canonical-narrowing pattern confirmed durable across 3 worked families (Domain 1/166=0.6%, Oracle Mystery 2/134=1.5%, Bloodrager Bloodline ~10/152=6.6%), each reach-checked or code-confirmed via a real consumer, per-family ratios reported individually not blended; family-by-family work stopped per team-lead's 3-family criterion; no unit's status changed; 1,772-unit remainder + 307-unit feat-side bucket remain open — see `decisions.md §52` | `epic-13-calibration` | epic-24-ultimate-intrigue | 2026-08-09T00:00:00-04:00 | SD28-E15-001 |
