...
| F0 | Class completion: permanent census instrument (RED first) | F0.1–F0.4 in epic-breakdown.md | **open** | 0 | Measured baseline 42 of 135 computed (`artifacts/epic-f/docs-truth/class-census.md`); scoped 2026-09-21 per `decisions.md §11`. Gated on D1 (done). |
