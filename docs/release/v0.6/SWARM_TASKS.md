...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 22 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin now do) | Backend | CRB/APG/ACG | in progress | Barbarian/Monk held pending a combat-time transient-state design pass. Sorcerer (c23d4054), Cleric (fca4e64e), and Druid (dda46d4a) all landed and lead-verified: Druid 344/344 lib + 212/212 desktop, 169-entry spell list count and 3 spot-checks exact, gate-ordering fix confirmed in code; all three correctly stay Blocked (bloodline/domain-powers/nature-bond diagnostics permanent). QA test targets: 28 Sorcerer + 28 Cleric (54 combined, closed) + 17 Druid (queued). Backend now scoping Bard, the last of the 4 spell-needing CRB classes; QA doing a proactive Bard spell-list/blocker survey in parallel |
