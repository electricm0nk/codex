...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 24 of 27 total classes need real BAB/save/HP/skill/spell/feature computation, not just the 8 CRB ones | Backend | CRB/APG/ACG | in progress | OPERATOR DIRECTIVE 2026-07-24 (risks item 8): primary active work. Ranger's BAB/save dispatch-widening landed f75cdff0 and is proven safe (lead-verified 4296/4296 + 212/212, all 4 adversarial-review requirements) -- CORRECTION: this does NOT mean Ranger reaches Computed yet (caught by frontend); Ranger's real spell posture is still genuinely uncomputed and unconditionally blocked. Clarifying with backend whether that's next or deferred, and confirming "done" means "reaches Computed" for every class going forward, not "dispatch landed safely" |
