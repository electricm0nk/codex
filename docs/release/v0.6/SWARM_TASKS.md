...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 22 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin now do) | Backend | CRB/APG/ACG | in progress | ACG coverage-audit gap fixed (a7ae86d6, QA correctly found 4 real full-BAB classes not 1, lead-verified against raw corpus). WORKSPACE FULLY CLEAN: 4330/4330 root-crate + 212/212 desktop, zero known gaps anywhere. Barbarian/Monk held pending a combat-time transient-state design pass. Sorcerer's known-spell posture landed (c23d4054, lead-verified 327/327 lib + 212/212 desktop, real spell list spot-checked) -- confirmed the one genuine cheap win among Cleric/Druid/Sorcerer/Bard; Bard confirmed NOT one (zero pre-built spell math, same as Cleric/Druid). 29 more QA test targets flagged, QA already on it. Backend now building Cleric's real 9-column spells-per-day table from scratch |
