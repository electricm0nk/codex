...
| Full class/race chassis breadth, all 4 primary books (CRB/Bestiary 1/APG/ACG) -- ~26 of ~29 total classes need real BAB/save/HP/skill/spell/feature computation, not just the 8 CRB ones | Backend | CRB/B1/APG/ACG | in progress | OPERATOR DIRECTIVE 2026-07-24, ~21:20 ET (risks item 8, corrected scope): primary active work, not backlog/future-epic. Dispatched now -- scoping/sequencing plan feeds directly into continuous implementation, not a parked decision |
