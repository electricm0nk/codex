...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 24 of 27 total classes need real BAB/save/HP/skill/spell/feature computation, not just the 8 CRB ones | Backend | CRB/APG/ACG | in progress | OPERATOR DIRECTIVE 2026-07-24 (risks item 8): primary active work. Class 1 of 24 (Ranger) landed f75cdff0, lead-verified 4296/4296 + 212/212 including all 4 adversarial-review requirements (level-1 stays honestly Blocked, real spell-posture diagnostic prevents false Computed at levels 2+, Paladin fully unaffected, multiclass combos tested); QA's 4-site tests/** update in progress |
| Class 2+ of 24 (next in sequence per class-multiclass-breadth-scoping.md) | Backend | CRB/APG/ACG | queued | begins once QA's Ranger test-fixture update lands and is verified |
