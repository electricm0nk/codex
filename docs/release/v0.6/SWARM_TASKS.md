...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 21 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin/Barbarian now do) | Backend | CRB/APG/ACG | in progress | Barbarian genuinely reaches Computed -- first class on the combat-time activation-state mechanism. Bard's Inspire Courage landed second (0374b96a), still Blocked on its own not-yet-built spell posture. Monk's Dodge burden closed for real (18920c3d, zero regression) -- table_class_id widening and its other 6 restricted-list feats remain. Sorcerer/Cleric/Druid all landed, correctly stay Blocked on their own permanent burden. All 11 CRB classes now have at least some real engine work landed. QA test targets: Sorcerer's 27, Cleric's 23, Druid's 17, and Barbarian's 22 all landed and lead-verified 100%; Bard's 32-file wave in progress now. Backend deciding next: whichever of Sorcerer/Cleric/Druid's permanent blockers (bloodline/domain/animal-companion) is most tractable, or Monk's other 6 feats. Real production bug in Druid's level-up filter found by QA and closed same-cycle. ge06_*/durability negative-control tests fixed twice, both self-caught, lead-verified. Detailed per-class/race table maintained in SWARM_REPORT.md |
