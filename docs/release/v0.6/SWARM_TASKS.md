...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 21 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin/Barbarian now do) | Backend | CRB/APG/ACG | in progress | MILESTONE: Barbarian genuinely reaches Computed (uncommitted, lead-verified 364/364 lib + 212/212 desktop) -- first class on the new combat-time activation-state mechanism (real conditional Rage engine: not-raging valid, actively-raging applies grounded bonuses, over-budget claim-blocks), one adversarial review completed and all 6 findings verified addressed. Sorcerer (c23d4054), Cleric (fca4e64e), and Druid (dda46d4a) all landed and lead-verified, correctly stay Blocked (bloodline/domain-powers/nature-bond diagnostics permanent). QA test targets: Sorcerer's 27 (76fe82da), Cleric's 23 (c578ede6), and Druid's full 17 (5eae17d7 + dfbb0810) all landed and lead-verified 100%; Barbarian's new 20-file wave queued next. REAL PRODUCTION BUG found by QA, lead-confirmed, and closed same-cycle: level_up/druid.rs's is_druid_pillar_id filter was dropping real, level-varying class_spell.druid.* grants from every Druid LevelUpPlan -- backend fixed with a one-line widening + doc comment (55a856c8), QA completed the 17th test file (dfbb0810), lead independently verified both. Bard's spell-list survey done and lead-verified exact (164 spells), spell posture still pending; backend now building Bard's Inspire Courage, reusing the proven activation-state pattern. ge06_*/durability negative-control tests fixed twice (Cleric->Barbarian, then Barbarian->Monk after Barbarian's own widening broke it again), both self-caught by backend or QA, lead-verified both times |
