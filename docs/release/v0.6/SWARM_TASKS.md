...
| Render an honest "not shown — outside demo corpus" indicator for the new unresolved-selection lists | UI | CRB | queued | backend's DTO fields ready (CorpusDerivedDto), UI treatment explicitly left as frontend's call |
