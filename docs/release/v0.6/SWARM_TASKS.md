...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 24 of 27 total classes need real BAB/save/HP/skill/spell/feature computation, not just the 8 CRB ones | Backend | CRB/APG/ACG | in progress | OPERATOR DIRECTIVE 2026-07-24, ~21:20 ET (risks item 8, corrected scope): primary active work, not backlog/future-epic. QA survey found CRB's 8 need only a narrow dispatch widening (BAB/save pillar), but APG/ACG's 16 need new ClassId/CLASS_META-equivalent plumbing -- no such infrastructure exists for those books yet |
