...
| Item 1 attack-bonus enhancement math for 2+ weapons (equipment-attachment schema) | Backend | CRB | queued | OPERATOR DECIDED 2026-07-24: add a real equipment-attachment schema field; sequence with item 27 below (same underlying data need) |
| Item 27 posture-gate widening (would `Computed` ever accept non-hardcoded equipment?) | Backend | CRB | queued | OPERATOR DECIDED 2026-07-24: widen the gate to accept any equipment; backend to produce a scoping/sequencing plan before implementation (large scope, ~347 call sites per the earlier design pass) |
...
| Wizard non-Human spell-math (spell-save-DC + spellbook-ceiling absent for non-Human) | Backend | CRB | done | 7c2d2ad2, lead-verified 4275/4275 + 204/204; Elf Wizard confirmed Computed at levels 1/3/4 with correct DC + ceiling |
