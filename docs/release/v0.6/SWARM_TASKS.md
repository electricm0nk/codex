...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 24 of 27 total classes still need real BAB/save/HP/skill/spell/feature computation to actually reach Computed | Backend | CRB/APG/ACG | in progress | OPERATOR DIRECTIVE 2026-07-24 (risks item 8): primary active work. Backend confirmed: "done" = reaches Computed for a real creatable character, not "dispatch widened safely." Ranger's BAB/save dispatch (f75cdff0) and APG's 6-class BAB/save/HP dispatch (c511c132) both landed and lead-verified (283/283 lib + 212/212 desktop) -- both correctly labeled as still Blocked (unconditional class-feature/spell diagnostics), not "done." Next: backend building Ranger's real spellcasting (spells known/day, save DCs, bonus slots) -- genuinely new engine work, no prior art anywhere in this codebase |
