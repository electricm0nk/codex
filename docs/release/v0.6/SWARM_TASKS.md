...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 22 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin now do) | Backend | CRB/APG/ACG | in progress | Barbarian/Monk held pending a combat-time transient-state design pass. Sorcerer (c23d4054) and Cleric (fca4e64e) both landed and lead-verified: 333/333 lib + 212/212 desktop, real spell lists spot-checked against raw corpus, both correctly stay Blocked (bloodline/domain-powers diagnostics permanent). Cleric's full 9-column spells-per-day table verified against 2 independent primary sources. 54 combined QA test targets flagged (28 Sorcerer + 28 Cleric); QA confirmed the count, accepted both diff-draft offers, flagging pace (not yet a bottleneck) |
