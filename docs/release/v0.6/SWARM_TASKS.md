...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 22 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin now do) | Backend | CRB/APG/ACG | in progress | Paladin's 29-file QA cleanup fully resolved (0 remaining failures). ACG's 10-class BAB/save/HP dispatch (71cd41b6) fully verified: 311/311 lib, 4123/4124 full workspace (1 known/expected ACG coverage-audit gap, same shape as APG's), 212/212 desktop. Only remaining gap: sd24_acg_class_coverage_audit.rs needs the same update APG's got |
