...
| Full class/race chassis breadth, CRB+APG+ACG (Bestiary has no classes) -- 21 of 27 total classes still need real work to actually reach Computed (Fighter/Wizard/Rogue/Ranger/Paladin/Barbarian now do) | Backend | CRB/APG/ACG | in progress | Barbarian genuinely reaches Computed (lead-verified 364/364 lib + 212/212 desktop) -- first class on the combat-time activation-state mechanism. Bard's Inspire Courage engine landed second (0374b96a, real attack-bonus wiring, lead-verified 368/368), still Blocked on its own not-yet-built spell posture. Sorcerer/Cleric/Druid all landed, correctly stay Blocked on their own permanent burden. QA test targets: Sorcerer's 27, Cleric's 23, Druid's full 17, and now Barbarian's 22 (5ba54695) all landed and lead-verified 100%; Bard's 32-file wave next. Backend now building Monk's Dodge exception (Dodge's mechanics already grounded elsewhere in the codebase, closes that one burden; other 6 restricted-list feats still need their own engine work). Real production bug in Druid's level-up filter found by QA and closed same-cycle (55a856c8 + dfbb0810 + 4e246e3b). ge06_*/durability negative-control tests fixed twice (Cleric->Barbarian, then Barbarian->Monk), both self-caught, lead-verified both times. Detailed per-class/race table now maintained in SWARM_REPORT.md |
