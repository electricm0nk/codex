...
use codex_ingest::pcgen_import::include_resolver::{
...
// (`codex_ingest::pcgen_import::pcc_package_loader`); the composer it feeds stayed in `rules_core`.
use codex_ingest::pcgen_import::pcc_package_loader::{
...
const DETERMINISTIC_FIXTURE: &str =
    include_str!("../../../tests/fixtures/rules_core/pf1_human_fighter_level5_sd18_preloop_deterministic_input.txt");
