...
use codex_ingest::pcgen_import::formula_interpreter::{extract_formula_field, PcgenFormulaEvaluator};
use codex_ingest::pcgen_import::formula_reproduction_harness::FormulaEvaluator;
...
fn mutated_evaluator_is_caught_disagreeing_with_the_family_fixtures() {
    ...
    impl FormulaEvaluator for OffByOneEvaluator {
        fn evaluate(
            ...
            formula: &str,
            vars: &BTreeMap<String, i64>,
        ) -> Result<i64, codex_ingest::pcgen_import::formula_reproduction_harness::FormulaEvalError> {
