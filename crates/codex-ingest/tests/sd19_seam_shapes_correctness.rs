...
use codex_ingest::pcgen_import::ir_converter::{convert_equipment_record, convert_spell_record};
...
fn fixture_text(name: &str) -> &'static str {
    match name {
        "abjuration" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_abjuration.txt"),
        "conjuration" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_conjuration.txt"),
        "divination" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_divination.txt"),
        "enchantment" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_enchantment.txt"),
        "evocation" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_evocation.txt"),
        "illusion" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_illusion.txt"),
        "necromancy" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_necromancy.txt"),
        "transmutation" => {
            include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_transmutation.txt")
        }
        "universal" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_spell_universal.txt"),
        "arms_armor" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_equip_arms_armor.txt"),
        "general" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_equip_general.txt"),
        "magic_items" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_equip_magic_items.txt"),
        "equipmods" => include_str!("../../../tests/fixtures/rules_core/sd19_seam_crb_equip_equipmods.txt"),
...
fn build_corpus() -> SourcePackageContent<'static> {
    ...
    for (school, _) in SPELL_FIXTURES {
        ...
        let record: &'static codex_ingest::pcgen_import::lst_parser::spell::LstSpellRecord =
    ...
    for (category, _) in EQUIPMENT_FIXTURES {
        ...
        for entry in result.entries {
            let entry: &'static codex_ingest::pcgen_import::lst_parser::equipment::EquipmentRecord =
