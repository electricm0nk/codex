...
use codex_ingest::oracle_validation::parity_report::{default_parity_report_dir, write_parity_report};
...
const DETERMINISTIC_FIXTURE: &str = include_str!(
    "../../../tests/fixtures/rules_core/pf1_human_wizard_level1_ge06_deterministic_input.txt"
);
