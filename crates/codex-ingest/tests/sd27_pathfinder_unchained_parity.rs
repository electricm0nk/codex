...
use codex_ingest::oracle_validation::comparator::compare;
use codex_ingest::oracle_validation::normalization::default_normalization_rules;
use codex_ingest::oracle_validation::parity_report::render_parity_report;
...
fn full_pipeline_runs_end_to_end_against_the_real_pu_pilot_case() {
    ...
    if !pcgen_gradle_wrapper_is_runnable(&pcgen_repo_dir) {
        eprintln!(
            "[skip] sd27_pathfinder_unchained_parity: real PCGen headless export not available under {} \
