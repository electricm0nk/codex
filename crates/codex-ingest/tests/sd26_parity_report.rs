...
use codex_ingest::oracle_validation::comparator::{
...
use codex_ingest::oracle_validation::selected_parity_dimensions::{
    ClaimTierFloor, SelectedDimension, SelectedParityDimensions,
};

fn pcgen_dim(id: &str, value_i16: i16) -> codex_ingest::oracle_validation::comparator::NormalizedDimensionValue
{
    codex_ingest::oracle_validation::comparator::NormalizedDimensionValue {
        id: id.to_string(),
        value_string: None,
...
fn sample_comparison() -> ComparisonResult {
    let pcgen = codex_ingest::oracle_validation::comparator::NormalizedOutput {
        dim_values: vec![
