...
//!
//! Verifies that [`codex_ingest::pcgen_import::lst_parser`]:
//!
...
//! the `use codex_ingest::pcgen_import::lst_parser::...` line; that compile
//! error is the RED state. Implementation in `src/pcgen_import/lst_parser.rs`
//! drives the transition to GREEN.

use std::path::PathBuf;

use codex_ingest::pcgen_import::lst_parser::race_ability::LstDiagnosticKind;
use codex_ingest::pcgen_import::lst_parser::{AbilityKind, parse_lst_entry};
