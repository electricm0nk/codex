...
//! [`SourceContentPayload`](codex::rules_core::source_content::SourceContentPayload),
...
// parser's enum; the canonical [`codex::rules_core::source_content::MetadataKindInner`]
...
/// Map a B-6 [`MetadataKind`] to the canonical [`codex::rules_core::source_content::MetadataKindInner`].
///
...
) -> codex::rules_core::source_content::MetadataKindInner {
...
/// [`codex::rules_core::source_content::MetadataKindInner`] back to the B-6
/// [`MetadataKind`].
pub fn canonical_metadata_kind_inner_to_b6(
    canonical: codex::rules_core::source_content::MetadataKindInner,
) -> MetadataKind {
    use codex::rules_core::source_content::MetadataKindInner;
    match canonical {
...
pub enum IrContentPayload<'a> {
    ...
    /// [`codex::rules_core::source_content::SourceContentKind`]
...
impl<'a> IrContentPayload<'a> {
    ...
    /// Mirrors [`codex::rules_core::source_content::SourceContentKind::token`]
    ...
    /// [`codex::rules_core::source_content::SourceContentKind::source_slice`].
...
mod boundary_tests {
    use super::*;
    use crate::pcgen_import::lst_parser::class::ClassEntry;
    use codex::rules_core::source_content::{MetadataKindInner, SourceRef};
