...
use codex::rules_core::record_vars::{
    ABILITY_SEED_NAMES, ConvertedVar, RecordVarPackage, class_level_call_key,
};
use codex::rules_core::sheet_rule::{Cmp, Expr, var_id};
...
mod tests {
    use super::*;
    use codex::rules_core::record_vars::{SeedAbilityMods, resolve_chain};
