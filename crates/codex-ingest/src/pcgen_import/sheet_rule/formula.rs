...
use codex::rules_core::sheet_rule::{Ability, ClassRef, Expr, HeldFilter, SpellKind};
...
pub fn cmp_expr(op: codex::rules_core::sheet_rule::Cmp, lhs: Expr, rhs: Expr) -> Expr {
    use codex::rules_core::sheet_rule::Cmp;
    match op {
