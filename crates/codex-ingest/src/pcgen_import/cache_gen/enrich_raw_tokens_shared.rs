...
use codex::rules_core::pi_screening::declared_product_identity;
...
/// ([`codex::rules_core::pi_screening::classify_field`]) union'd with the
...
pub fn screen_field_value(key: &str, value: &str, declared_description: bool) -> (String, bool) {
    ...
    let (license, ..) = codex::rules_core::pi_screening::classify_field(key, value);
