...
/// itself is
/// [`rules_core::pilot_compute::resolved_prose::leaked_markup`](codex::rules_core::pilot_compute::resolved_prose::leaked_markup),
...
pub fn leaked_pcgen_syntax(text: &str) -> Option<&'static str> {
    codex::rules_core::pilot_compute::resolved_prose::leaked_markup(text)
}
