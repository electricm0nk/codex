...
fn main() {
    ...
    let out_root = codex_ingest::repo_root().join("data/corpus/advanced_players_guide/race_trait");
    ...
    let arg_keys = already_ingested_keys(
        &codex_ingest::repo_root().join("data/corpus/advanced_race_guide/race_trait"),
    );
...
mod tests {
    ...
    fn already_ingested_keys_reads_real_keys_off_disk_not_a_hand_list() {
        let dir = codex_ingest::repo_root().join("data/corpus/advanced_race_guide/race_trait");
    ...
    fn no_committed_apg_trait_description_leaks_pcgen_syntax() {
        ...
        let trait_root = codex_ingest::repo_root().join("data/corpus/advanced_players_guide/race_trait");
