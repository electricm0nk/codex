...
//! [`codex_ingest::pcgen_import::corpus_literal_sweep`]. This file is the walker: it
...
use codex_ingest::pcgen_import::corpus_literal_sweep::{
...
use codex_ingest::pcgen_import::wiring_class::build_mod_index;
...
fn main() -> ExitCode {
    let mut repo_root = codex_ingest::repo_root();
