...
//! `codex_ingest::pcgen_import::bonus_stack_reader` (kanban card 8,
...
//!   [`codex_ingest::pcgen_import::bonus_stack_reader::resolve_all_producer_chains_corpus_wide`]
...
use codex_ingest::pcgen_import::bonus_stack_reader::{
