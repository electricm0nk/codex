...
use codex_ingest::pcgen_import::ingest_payload::{RaceCacheData, RaceTraitCacheData, RawBonusChain, RawToken};
...
fn main() {
    ...
    let out_root = codex_ingest::repo_root().join("data/corpus");
...
mod tests {
    ...
    fn every_committed_race_record_on_disk_deserializes_through_the_shape_b_v1_schema() {
        ...
        let root = codex_ingest::repo_root().join("data/corpus");
    ...
    fn the_two_reported_rows_render_exactly_as_specified() {
        let root = codex_ingest::repo_root().join("data/corpus/core_rulebook/race_trait");
