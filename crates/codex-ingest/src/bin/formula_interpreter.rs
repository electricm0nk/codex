...
//! real logic lives in
//! [`codex_ingest::pcgen_import::formula_interpreter_corpus_wide::run_corpus_wide_scan`],
...
use codex_ingest::pcgen_import::formula_interpreter_corpus_wide::{
            ...
            "--help" => {
                println!(
                    "{LABEL}: usage: formula_interpreter --corpus-wide --output <path>\n\
                     ...
                     codex_ingest::pcgen_import::formula_interpreter_corpus_wide."
                );
