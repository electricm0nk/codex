...
fn sorcerer_level16_still_recognizes_the_spell_bearing_baseline_and_claim_blocks_burdens() {
    ...
    assert!(
        ...
        "level-16 Sorcerer must still claim-block on the spontaneous which-spells-known / \
...
fn sorcerer_level_17_is_not_promoted_by_this_slice() {
    let level_17 = SORCERER_LEVEL16_FIXTURE.replace("class:sorcerer:16", "class:sorcerer:17");
