...
fn wrong_fighter_level_blocks_total_saves() {
    ...
    // 1-16 (SD13-E5 widened levels 9-10, Weapon Training 2 and the level-10 bonus
    ...
    // 15, Armor Training 4, and level 16, an eighth bonus-feat cadence slot,
    // into the supported tranche). A Fighter above that bounded tranche
    // (level 17+, beyond the SD-13/SD-18 level-16 progression matrix) must
