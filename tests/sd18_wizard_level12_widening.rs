...
// (widened from level 13 to level 15 by the SD18 wizard-level13-widening and
// wizard-level14-widening cycles, which genuinely promote levels 13 and 14
// — see tests/sd18_wizard_level13_widening.rs and
...
// level-14 widening cycles each made for their own sibling level-12
// widening test.)

#[test]
fn wizard_level_15_is_not_promoted_by_this_slice() {
    let level_15 = WIZARD_LEVEL12_FIXTURE.replace("class:wizard:12", "class:wizard:15");
