...
fn wrong_fighter_level_blocks_combat_totals() {
    ...
    // milestone levels 1-17 (SD13-E5 widened levels 9-10, Weapon Training 2 and
    ...
    // slot, and level 17, Weapon Training 4 and a fourth weapon-group choice
    // slot, into the supported tranche). A Fighter above that bounded
    // tranche (level 18+, beyond the SD-13/SD-18 level-17 progression
