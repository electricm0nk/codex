...
fn sorcerer_level17_still_recognizes_the_spell_bearing_baseline_and_claim_blocks_burdens() {
    ...
    assert!(
        ...
        "level-17 Sorcerer must still claim-block on the spontaneous which-spells-known / \
...
fn sorcerer_level_18_is_not_promoted_by_this_slice() {
    let level_18 = SORCERER_LEVEL17_FIXTURE.replace("class:sorcerer:17", "class:sorcerer:18");
