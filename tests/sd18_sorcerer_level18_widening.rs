...
fn sorcerer_level18_still_recognizes_the_spell_bearing_baseline_and_claim_blocks_burdens() {
    ...
    assert!(
        ...
        "level-18 Sorcerer must still claim-block on the spontaneous which-spells-known / \
...
fn sorcerer_level_19_is_not_promoted_by_this_slice() {
    let level_19 = SORCERER_LEVEL18_FIXTURE.replace("class:sorcerer:18", "class:sorcerer:19");
