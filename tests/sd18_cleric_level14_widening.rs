...
// cycle-2026-07-15T9600 widened it from 16 to 17, so this file's own
// negative-control boundary moves from 17 to 18, mirroring the exact same
...
fn cleric_level_18_is_not_promoted_by_this_slice() {
    let level_18 = CLERIC_LEVEL14_FIXTURE.replace("class:cleric:14", "class:cleric:18");
