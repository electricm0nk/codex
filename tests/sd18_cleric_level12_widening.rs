...
// 17, then cycle-2026-07-15T14300 widened it from 17 to 18, so this file's
// own negative-control boundary moves from 18 to 19,
...
fn cleric_level_19_is_not_promoted_by_this_slice() {
    let level_19 = CLERIC_LEVEL12_FIXTURE.replace("class:cleric:12", "class:cleric:19");
