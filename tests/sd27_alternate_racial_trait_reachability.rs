...
fn the_pure_flag_table_agrees_with_the_disk_backed_resolver_for_every_alternate() {
    ...
    assert_eq!(checked, 361, "153 ARG + 8 Monster Codex (4 original + SD-32 card-11 T2b's 4 Ratfolk alternates, 2026-08-23) + 1 APG + 67 Inner Sea Races + 41 Horror Adventures + 16 Core Essentials heritages + SD-31-E6-F4-003's 19 (round 5; the book's other 5 new records -- Strix's Wing-Clipped-granted Flight plus Suli's Energy-Strike-granted Earthfoot/Firehand/Icewalk/Shockshield -- are never selectable, same as the prior rounds' dependent rows) + SD31-E6-F4-006's 8 (round 6, 2026-08-17: Gillman 3, Nagaji 1, Vanara 2, Vishkanya 2). The 158 this pin held until 2026-08-12 was round 2's miss, not a smaller corpus: ISR's 68 landed on 2026-08-11 and this assertion went RED unnoticed until round 3 reproduced the gate (SD-29 decisions.md 47)");
    assert_eq!(selectable_alternate_trait_keys().len(), 361, "153 ARG + 8 Monster Codex (4 original + SD-32 card-11 T2b's 4 Ratfolk alternates, 2026-08-23) + 1 APG + 67 Inner Sea Races + 41 Horror Adventures + 16 Core Essentials heritages + SD-31-E6-F4-003's 19 (round 5; the book's other 5 new records -- Strix's Wing-Clipped-granted Flight plus Suli's Energy-Strike-granted Earthfoot/Firehand/Icewalk/Shockshield -- are never selectable, same as the prior rounds' dependent rows) + SD31-E6-F4-006's 8 (round 6, 2026-08-17: Gillman 3, Nagaji 1, Vanara 2, Vishkanya 2). The 158 this pin held until 2026-08-12 was round 2's miss, not a smaller corpus: ISR's 68 landed on 2026-08-11 and this assertion went RED unnoticed until round 3 reproduced the gate (SD-29 decisions.md 47)");
}
...
fn the_three_dependent_rows_are_not_offered_as_choices_and_the_menu_is_exactly_the_alternates() {
    ...
    assert_eq!(
        ...
        "175 standard + 156 ARG + 5 Monster Codex + 1 APG + 71 Inner Sea Races \
         ...
         + the 2 dependent rows Surface Sprinter grants; 794 -> 812)"
    );
    assert_eq!(
        arg,
        414,
    ...
    assert_eq!(selectable.len(), 361, "153 ARG + 8 Monster Codex (4 original + SD-32 card-11 T2b's 4 Ratfolk alternates, 2026-08-23) + 1 APG + 67 Inner Sea Races + 41 Horror Adventures + 16 Core Essentials heritages + SD-31-E6-F4-003's 19 (round 5; the book's other 5 new records -- Strix's Wing-Clipped-granted Flight plus Suli's Energy-Strike-granted Earthfoot/Firehand/Icewalk/Shockshield -- are never selectable, same as the prior rounds' dependent rows) + SD31-E6-F4-006's 8 (round 6, 2026-08-17: Gillman 3, Nagaji 1, Vanara 2, Vishkanya 2). The 158 this pin held until 2026-08-12 was round 2's miss, not a smaller corpus: ISR's 68 landed on 2026-08-11 and this assertion went RED unnoticed until round 3 reproduced the gate (SD-29 decisions.md 47)");
    for dependent in [
        "Feral ~ Languages",
...
fn no_ingested_race_trait_key_contains_a_colon_so_the_storage_namespace_is_lossless() {
    ...
    assert_eq!(
        ...
        "515 -> 628 by SD-31 Epic 1-F2 (2026-08-15); 628 -> 637 by the Skinwalker follow-on \
         ...
         alternates + their 2 grant-linked rows (2026-08-23)"
    );
}
...
fn every_alternate_computes_on_its_own_race_without_an_unknown_key_diagnostic() {
    ...
    assert_eq!(computed, 361, "153 ARG + 8 Monster Codex (4 original + SD-32 card-11 T2b's 4 Ratfolk alternates, 2026-08-23) + 1 APG + 67 Inner Sea Races + 41 Horror Adventures + 16 Core Essentials heritages + SD-31-E6-F4-003's 19 (round 5; the book's other 5 new records -- Strix's Wing-Clipped-granted Flight plus Suli's Energy-Strike-granted Earthfoot/Firehand/Icewalk/Shockshield -- are never selectable, same as the prior rounds' dependent rows) + SD31-E6-F4-006's 8 (round 6, 2026-08-17: Gillman 3, Nagaji 1, Vanara 2, Vishkanya 2). The 158 this pin held until 2026-08-12 was round 2's miss, not a smaller corpus: ISR's 68 landed on 2026-08-11 and this assertion went RED unnoticed until round 3 reproduced the gate (SD-29 decisions.md 47)");
}
