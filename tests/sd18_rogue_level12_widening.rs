...
// ----- Negative control: level 17 stays claim-blocked (beyond the bounded L1-14 row) -----
//
...
// now genuinely recognizes level 16 too, so this boundary control moves
// again, to level 17.

#[test]
fn rogue_level_17_stays_claim_blocked() {
    let level_17 = ROGUE_LEVEL12_FIXTURE.replace("class:rogue:12", "class:rogue:17");
