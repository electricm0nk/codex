...
// current bound (level 20) rather than at level 13, level 14, level 15,
// level 16, level 17, level 18, or level 19.

#[test]
fn fighter_level_20_stays_claim_blocked() {
    let level_20 = FIGHTER_LEVEL12_FIXTURE.replace("class:fighter:12", "class:fighter:20");
