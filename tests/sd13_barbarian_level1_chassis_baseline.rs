...
fn matrix_barbarian_row_is_partial_computed_and_names_rage_execution_as_still_unproven() {
    ...
    // level-2/level-3/level-4/level-5/level-6/level-7 widenings); the rage-state
    // execution engine is the named remaining burden, and weapon familiarity /
    // level-8+ stay unclaimed.
    for token in [
        "base attack",
        "base save",
        "fast movement",
