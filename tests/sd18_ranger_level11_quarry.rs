...
// genuinely recognizes Ranger level 18 too, so this boundary control moves
// once more to level 19.
#[test]
fn ranger_level_19_is_not_promoted_by_this_slice() {
    let level_19 = RANGER_LEVEL11_FIXTURE.replace("class:ranger:11", "class:ranger:19");
