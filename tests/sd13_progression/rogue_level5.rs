...
recognition_negative_controls! {
    fighter_does_not_gain_rogue_level5_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_rogue_level5_is_not_promoted_by_this_slice(ROGUE_LEVEL5_FIXTURE, "class_level=class:rogue:5" => "class_level=class:rogue:5\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.rogue."],
        exact: [ROGUE_EVASION_ID, ROGUE_TRAP_SENSE_ID, ROGUE_UNCANNY_DODGE_ID],
