...
recognition_negative_controls! {
    fighter_does_not_gain_cleric_level10_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_cleric_level10_is_not_promoted_by_this_slice(CLERIC_LEVEL10_FIXTURE, "class_level=class:cleric:10" => "class_level=class:cleric:10\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.cleric."],
        exact: [],
