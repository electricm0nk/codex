...
recognition_negative_controls! {
    fighter_does_not_gain_bard_level2_recognition(FIGHTER_FIXTURE) {
        prefixes: ["class_chassis.bard."],
        exact: ["class_chassis.spell_baseline.bard", WELL_VERSED_ID],
        message: "the Fighter chassis must not surface any bard-namespaced explanation: {:?}",
    },
}

multiclass_negative_controls! {
    multiclass_bard_level2_is_not_promoted_by_this_slice(BARD_LEVEL2_FIXTURE, "class_level=class:bard:2" => "class_level=class:bard:2\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.bard."],
        exact: ["class_chassis.spell_baseline.bard", WELL_VERSED_ID],
