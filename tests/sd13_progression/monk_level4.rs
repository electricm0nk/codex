...
recognition_negative_controls! {
    fighter_does_not_gain_monk_level4_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_monk_level4_is_not_promoted_by_this_slice(MONK_LEVEL4_FIXTURE, "class_level=class:monk:4" => "class_level=class:monk:4\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.monk."],
        exact: [MONK_EVASION_ID, MONK_STILL_MIND_ID],
