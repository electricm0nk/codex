...
recognition_negative_controls! {
    fighter_does_not_gain_rogue_level7_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_rogue_level7_is_not_promoted_by_this_slice(ROGUE_LEVEL7_FIXTURE, "class_level=class:rogue:7" => "class_level=class:rogue:7\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.rogue."],
        exact: [ROGUE_EVASION_ID, ROGUE_TRAP_SENSE_ID, ROGUE_UNCANNY_DODGE_ID],
