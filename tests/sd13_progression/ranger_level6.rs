...
recognition_negative_controls! {
    fighter_does_not_gain_ranger_level6_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_ranger_level6_is_not_promoted_by_this_slice(RANGER_LEVEL6_FIXTURE, "class_level=class:ranger:6" => "class_level=class:ranger:6\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.ranger."],
        exact: [ENDURANCE_ID, FAVORED_TERRAIN_ID, HUNTERS_BOND_ID],
