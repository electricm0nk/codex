...
recognition_negative_controls! {
    fighter_does_not_gain_barbarian_level5_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_barbarian_level5_is_not_promoted_by_this_slice(BARBARIAN_LEVEL5_FIXTURE, "class_level=class:barbarian:5" => "class_level=class:barbarian:5\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.barbarian."],
        exact: [BARBARIAN_UNCANNY_DODGE_ID, BARBARIAN_TRAP_SENSE_ID, BARBARIAN_IMPROVED_UNCANNY_DODGE_ID],
