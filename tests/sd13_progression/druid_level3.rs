...
recognition_negative_controls! {
    fighter_does_not_gain_druid_level3_recognition(FIGHTER_FIXTURE) {
        prefixes: ["class_chassis.druid."],
        exact: ["class_chassis.spell_baseline.druid", DRUID_WOODLAND_STRIDE_ID, DRUID_TRACKLESS_STEP_ID],
