...
recognition_negative_controls! {
    fighter_does_not_gain_sorcerer_level9_recognition(FIGHTER_FIXTURE) {
...
multiclass_negative_controls! {
    multiclass_sorcerer_level9_is_not_promoted_by_this_slice(SORCERER_LEVEL9_FIXTURE, "class_level=class:sorcerer:9" => "class_level=class:sorcerer:9\nclass_level=class:fighter:1") {
        prefixes: ["class_chassis.sorcerer."],
        exact: ["class_chassis.spell_baseline.sorcerer"],
