...
fn rogue_level12_base_attack_bonus_and_saves_genuinely_rise() {
    let computation = crate::support::compute(ROGUE_LEVEL12_FIXTURE);
...
fn rogue_level12_without_selection_fabricates_no_slot_6_record() {
    let no_selection = ROGUE_LEVEL12_FIXTURE
        ...
        .collect::<Vec<_>>()
        .join("\n");
    let computation = crate::support::compute(&no_selection);
...
fn rogue_level11_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(ROGUE_LEVEL11_FIXTURE);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_rogue_level12_recognition, "rogue");

// ----- Negative control: multiclass Rogue is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_rogue_level12_is_not_promoted_by_this_slice, "rogue_level12", ROGUE_LEVEL12_FIXTURE);
