...
fn sorcerer_level18_base_attack_bonus_is_grounded() {
    let computation = crate::support::compute(SORCERER_LEVEL18_FIXTURE);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_sorcerer_level18_recognition, "sorcerer");

// ----- Negative control: multiclass Sorcerer is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_sorcerer_level18_is_not_promoted_by_this_slice, "sorcerer_level18", SORCERER_LEVEL18_FIXTURE);
