...
fn wizard_level20_base_attack_and_good_will_rise() {
    let computation = crate::support::compute(WIZARD_LEVEL20_FIXTURE);
...
crate::sd18_boundary_neg_control_test!(wizard_level_21_is_not_promoted_by_this_slice, "wizard_level20", WIZARD_LEVEL20_FIXTURE);

// ----- Negative control: the wizard path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_wizard_level20_recognition, "wizard");
