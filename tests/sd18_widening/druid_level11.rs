...
fn druid_level10_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(DRUID_LEVEL10_FIXTURE);
...
fn druid_level_21_is_not_promoted_by_this_slice() {
    ...
    let level_21 = DRUID_LEVEL11_FIXTURE.replace("class:druid:11", "class:druid:21");
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_druid_level11_recognition, "druid");
