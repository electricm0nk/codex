...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_paladin_level16_recognition, "paladin");

// ----- Negative control: multiclass Paladin is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_paladin_level16_is_not_promoted_by_this_slice, "paladin_level16", PALADIN_LEVEL16_FIXTURE);
