...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_barbarian_level19_recognition, "barbarian");

// ----- Negative control: multiclass Barbarian is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_barbarian_level19_is_not_promoted_by_this_slice, "barbarian_level19", BARBARIAN_LEVEL19_FIXTURE);
