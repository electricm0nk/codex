...
fn barbarian_level15_base_attack_and_poor_saves_rise_fortitude_stays() {
    let computation = crate::support::compute(BARBARIAN_LEVEL15_FIXTURE);
...
crate::sd18_boundary_neg_control_test!(barbarian_level_21_is_not_promoted_by_this_slice, "barbarian_level15", BARBARIAN_LEVEL15_FIXTURE);

// ----- Negative control: the barbarian path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_barbarian_level15_recognition, "barbarian");

// ----- Negative control: multiclass Barbarian is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_barbarian_level15_is_not_promoted_by_this_slice, "barbarian_level15", BARBARIAN_LEVEL15_FIXTURE);
