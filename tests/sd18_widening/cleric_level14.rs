...
fn cleric_level14_base_attack_and_good_saves_genuinely_rise() {
    let computation = crate::support::compute(CLERIC_LEVEL14_FIXTURE);
...
fn cleric_level13_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(CLERIC_LEVEL13_FIXTURE);
...
crate::sd18_boundary_neg_control_test!(cleric_level_21_is_not_promoted_by_this_slice, "cleric_level14", CLERIC_LEVEL14_FIXTURE);

// ----- Negative control: the cleric path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_cleric_level14_recognition, "cleric");

// ----- Negative control: multiclass Cleric is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_cleric_level14_is_not_promoted_by_this_slice, "cleric_level14", CLERIC_LEVEL14_FIXTURE);
