...
fn bard_level13_base_attack_and_saves_stay_unchanged() {
    let computation = crate::support::compute(BARD_LEVEL13_FIXTURE);
...
crate::sd18_boundary_neg_control_test!(bard_level_21_is_not_promoted_by_this_slice, "bard_level13", BARD_LEVEL13_FIXTURE);

// ----- Negative control: the bard path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_bard_level13_recognition, "bard");

// ----- Negative control: multiclass Bard is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_bard_level13_is_not_promoted_by_this_slice, "bard_level13", BARD_LEVEL13_FIXTURE);
