...
crate::sd18_boundary_neg_control_test!(cleric_level_21_is_not_promoted_by_this_slice, "cleric_level13", CLERIC_LEVEL13_FIXTURE);

// ----- Negative control: the cleric path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_cleric_level13_recognition, "cleric");

// ----- Negative control: multiclass Cleric is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_cleric_level13_is_not_promoted_by_this_slice, "cleric_level13", CLERIC_LEVEL13_FIXTURE);
