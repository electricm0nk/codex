...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_rogue_level15_recognition, "rogue");

// ----- Negative control: multiclass Rogue is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_rogue_level15_is_not_promoted_by_this_slice, "rogue_level15", ROGUE_LEVEL15_FIXTURE);
