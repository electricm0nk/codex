...
crate::sd18_boundary_neg_control_test!(cleric_level_21_is_not_promoted_by_this_slice, "cleric_level19", CLERIC_LEVEL19_FIXTURE);

// ----- Negative control: the cleric path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_cleric_level19_recognition, "cleric");

// ----- Negative control: multiclass Cleric is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_cleric_level19_is_not_promoted_by_this_slice, "cleric_level19", CLERIC_LEVEL19_FIXTURE);
