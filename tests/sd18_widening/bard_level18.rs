...
fn bard_level17_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(BARD_LEVEL17_FIXTURE);
...
crate::sd18_boundary_neg_control_test!(bard_level_21_is_not_promoted_by_this_slice, "bard_level18", BARD_LEVEL18_FIXTURE);

// ----- Negative control: the bard path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_bard_level18_recognition, "bard");

// ----- Negative control: multiclass Bard is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_bard_level18_is_not_promoted_by_this_slice, "bard_level18", BARD_LEVEL18_FIXTURE);
