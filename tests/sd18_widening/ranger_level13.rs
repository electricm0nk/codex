...
fn ranger_level13_targeting_the_third_terrain_boosts_the_third_terrain() {
    ...
    let computation = crate::support::compute(&swapped);
...
fn ranger_level13_unrecognized_thirteenth_level_target_boosts_nothing() {
    ...
    let computation = crate::support::compute(&unrecognized);
...
crate::sd18_boundary_neg_control_test!(ranger_level_21_is_not_promoted_by_this_slice, "ranger_level13", RANGER_LEVEL13_FIXTURE);

// ----- Negative control: the ranger path must not leak onto other classes -----

crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_ranger_level13_recognition, "ranger");

// ----- Negative control: multiclass Ranger is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_ranger_level13_is_not_promoted_by_this_slice, "ranger_level13", RANGER_LEVEL13_FIXTURE);
