...
fn cleric_level16_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(CLERIC_LEVEL16_FIXTURE);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_cleric_level17_recognition, "cleric");

// ----- Negative control: multiclass Cleric is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_cleric_level17_is_not_promoted_by_this_slice, "cleric_level17", CLERIC_LEVEL17_FIXTURE);
