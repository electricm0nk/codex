...
fn ranger_level15_base_attack_bonus_genuinely_rises() {
    let computation = crate::support::compute(RANGER_LEVEL15_FIXTURE);
...
fn ranger_level15_fourth_favored_enemy_absent_grounds_nothing() {
    ...
    let computation = crate::support::compute(&without_fourth);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_ranger_level15_recognition, "ranger");

// ----- Negative control: multiclass Ranger is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_ranger_level15_is_not_promoted_by_this_slice, "ranger_level15", RANGER_LEVEL15_FIXTURE);
