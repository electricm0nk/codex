...
fn sorcerer_level15_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(SORCERER_LEVEL15_FIXTURE);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_sorcerer_level16_recognition, "sorcerer");

// ----- Negative control: multiclass Sorcerer is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_sorcerer_level16_is_not_promoted_by_this_slice, "sorcerer_level16", SORCERER_LEVEL16_FIXTURE);
