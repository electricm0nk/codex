...
fn cleric_level15_truth_is_unchanged_by_this_slice() {
    let computation = crate::support::compute(CLERIC_LEVEL15_FIXTURE);
...
crate::sd18_fighter_neg_control_test!(fighter_does_not_gain_cleric_level16_recognition, "cleric");

// ----- Negative control: multiclass Cleric is not promoted -----

crate::sd18_multiclass_neg_control_test!(multiclass_cleric_level16_is_not_promoted_by_this_slice, "cleric_level16", CLERIC_LEVEL16_FIXTURE);
