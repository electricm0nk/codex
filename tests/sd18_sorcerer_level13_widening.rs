...
// so this boundary moved from 18 to 19, mirroring the exact same boundary move made
// to every other sorcerer sibling test file this cycle.

#[test]
fn sorcerer_level_20_is_not_promoted_by_this_slice() {
    let level_20 = SORCERER_LEVEL13_FIXTURE.replace("class:sorcerer:13", "class:sorcerer:20");
