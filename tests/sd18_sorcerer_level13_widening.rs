...
// so this boundary moved from 14 to 15, mirroring the exact same boundary move made
// to every other sorcerer sibling test file this cycle.

#[test]
fn sorcerer_level_15_is_not_promoted_by_this_slice() {
    let level_15 = SORCERER_LEVEL13_FIXTURE.replace("class:sorcerer:13", "class:sorcerer:15");
