...
// other Barbarian/Bard/Cleric/Fighter/Paladin/Rogue/Ranger/Wizard level-18
...
fn sorcerer_level_20_is_not_promoted_by_this_slice() {
    let level_20 = SORCERER_LEVEL10_FIXTURE.replace("class:sorcerer:10", "class:sorcerer:20");
